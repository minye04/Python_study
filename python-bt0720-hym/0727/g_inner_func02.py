...
print(max([1, 2, 3, 4, 5]))
print(max([543, 24, 636, 12, 655]))

print(min([1, 2, 3, 4, 5]))
print(min([543, 24, 636, 12, 655]))
...
# sum()
# sum(iterable, strar): iterable의 모든 항목과 시작값을 더한 결과를 반환
# start 생략 시 iterable값달만을 더한 결과를 반환 (시작값이 0)
