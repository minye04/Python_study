...
# If문 : 만약 ~ 라면
# 해당 조건이 참(True)인 경우에만 코드 불록을 실행
...
# 2. 기본 if문
# 어떤 수가 10보다 큰 지 확인하는 조건문 작성

num = 15

if num > 10:
    print('The number is greater tham 10.')
...
# 어떤 수가 10보다 큰 지, 10인지, 또는 10보다 작은 지를 확인하는 코드
num = 11
...
# 삼항연산자
# value_if_true(변수명) if condition(조건) else value_if_false(실행될 코드-거짓)
...
# 어떤 숫자가 10보다 큰 지 아닌 지를 판단하여 문자열을 반환하는 삼항 연산자
num = 15
