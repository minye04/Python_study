...
조건: 루프(조건)가 계속 실행되는 지 아니면 중단되는 지 를 결정하는 boolean타입 표현식
'''
...
while True:
    ...
    if not userInput.isdigit():
        print('숫자만 입력해주세요!')
        continue
    # isdigit(): 문자열이 숫자로만 이루어져 있는 지 확인하는 함수
    # 문자가 '단 하나'라도 있으면 False
    # 모든 문자가 '숫자'로만 이루어져 있으면 True를 반환
    print(f'입력하신 숫자 {userInput}입니다.')