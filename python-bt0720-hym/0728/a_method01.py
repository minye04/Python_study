...
# 1. format() 메소드: 문자열에 변소를 삽입 or 형식을 지정하는 데 사용
print('Hello, {}. I am {} years old'. format('yemin', 50))
